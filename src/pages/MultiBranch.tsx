...
const branches = [
  {
    id: "1",
    name: "Colombo – Bambalapitiya",
    address: "No. 45 Galle Road, Bambalapitiya, Colombo 04",
    phone: "+94 11 2 345 678",
    manager: "Indika Rathnayake",
    staff: 15,
    revenue: 125750,
    status: "active",
  ...
  {
    id: "2", 
    name: "Kandy – Peradeniya Road",
    address: "No. 12 Peradeniya Road, Kandy",
    phone: "+94 81 2 234 567",
    manager: "Chamari Gunasekara",
    staff: 12,
    revenue: 98500,
    status: "active",
  ...
  },
  {
    id: "3",
    name: "Galle – Fort", 
    address: "Pedlar Street, Galle Fort, Galle",
    phone: "+94 91 2 234 890",
    manager: "Dinesh Kumara",
    staff: 10,
    revenue: 72500,
    status: "maintenance",
  ...
  {
    id: "4",
    name: "Negombo – Lewis Place",
    address: "Lewis Place, Negombo",
    phone: "+94 31 2 345 123", 
    manager: "Shani Perera",
    staff: 8,
    revenue: 48500,
    status: "active",
